...
function multiplicarArgumentos() {
   ...
   let producto = arguments.length > 0 ? 1 : 0;
...
//  console.log(empiezaConNueve(2828283));
...
function todosIguales(array) {
   ...
   for (let elemento of array){
      // console.log(elemento0,elemento)
      if (elemento0 != elemento){
         return false;
      }
...
function mayorACien(array) {
   ...
   for (numero of array){
      if (numero >100){
         matNumerosMayorCien.push(numero)
      }


   }
   return matNumerosMayorCien;
}
...
// console.log(devolverPrimerElemento([10,9,8]));
// console.log(devolverUltimoElemento([10,9,8]));
